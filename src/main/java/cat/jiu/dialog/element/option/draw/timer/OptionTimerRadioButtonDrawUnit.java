...
@ZenRegister
@ZenClass("dialog.draw.timer.RadioButton")
public class OptionTimerRadioButtonDrawUnit extends OptionRadioButtonDrawUnit {
	protected final OptionTimerRadioButton option;
	@SideOnly(Side.CLIENT)
	public OptionTimerRadioButtonDrawUnit(ResourceLocation dialogID, OptionTimerRadioButton option, int id, DialogDimension dim) {
...
//				GlStateManager.pushMatrix();
				GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);gui.drawGradientRect(x+2, y+2, x+8, y+8, Color.BLACK.getRGB(), Color.BLACK.getRGB());
